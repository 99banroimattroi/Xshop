				...
				<div class="col-sm-7">
					<div class="product-information">
						...
						<div class="product__size">
							...
							<div class="product__size-proprety">
							<input type="radio" id="s" name="size" value="male">
                                  <label for="s">S</label><br>
                            <input type="radio" id="m" name="size" value="female">
                                  <label for="m">M</label><br>
                            <input type="radio" id="l" name="size" value="other">
                                  <label for="l">L</label>
							<input type="radio" id="l" name="size" value="other">
                                  <label for="l">XL</label>
							<input type="radio" id="l" name="size" value="other">
                                  <label for="l">XXL</label>	  
							<input type="radio" id="l" name="size" value="other">
                                  <label for="l">XXX</label>
							</div>
						</div>
...
<img  alt="Zoom Image Affect" id="myimage" src="image.jpg" width="300" />
  <br />
<div class="img-zoom-result" id="myresult">
</div> -->
</div>
